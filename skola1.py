...
# kontrola registrovaného uzivatele, mohlo to jit i lepe :-)
if (input_user + input_pass) in (user_1, user_2, user_3, user_4):
    print(underline)
    ...
    if vybrana_volba in (1, 2, 3):
        ...
        pocet_slov = TEXTS[vybirac].split()
